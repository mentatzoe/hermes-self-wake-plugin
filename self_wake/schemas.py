...
SELF_WAKE_RECEIPTS = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "status": {"type": "string", "description": "Filter by receipt status. Valid values: requested, dispatched, queued, agent_responded, dispatched_unconfirmed, failure, deduped."},
