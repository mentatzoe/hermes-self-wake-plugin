...
SELF_WAKE_RECEIPTS = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "status": {"type": "string", "description": "Filter by receipt status: requested, dispatching, pending, dispatched, queued, agent_responded, dispatched_unconfirmed, failure. Native pending/dispatching are not confirmed delivery; deduped is a call result, not a stored status."},
